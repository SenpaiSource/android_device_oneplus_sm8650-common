...
$(call soong_config_set,libcameraservice,ext_lib,//$(LOCAL_PATH):libcameraservice_extension.oneplus_sm8650)
...
PRODUCT_COPY_FILES += \
>>>>>>> fe78921 (sm8650-common: Allow surfaceflinger to use the big cluster)
